      ...
      <div>
        <div className="folder" onClick={() => setExpand(!expand)}>
          ...
          <div className="editions">
            ...
            <div
              className="tooltip"
              onClick={() => handleDeleteNode(explorer.id, explorer.isFolder)}
            >
              <AiOutlineDelete />
        ...
        >
          {showInput.visible && (
            <div className="inputContainer">
              <span>
                {showInput.isFolder ? <VscNewFolder /> : <VscNewFile />}
              </span>
              <input
                type="text"
